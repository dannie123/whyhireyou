...
{{--         <link href="/../../assets/plugins/pace-master/themes/blue/pace-theme-flash.css" rel="stylesheet"/>
        ...
        <!-- Theme Styles -->
        {!! HTML::style('assets/css/modern.css') !!}
        {!! HTML::style('assets/css/themes/white.css', ['class'=>'theme-color']) !!}
    ...
    <body class="page-header-fixed">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s1">
            ...
            <div class="slimscroll">
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar2.png') !!}<span>Sandra smith<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar3.png') !!}<span>Amily Lee<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar4.png') !!}<span>Christopher Palmer<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar5.png') !!}<span>Nick Doe<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar2.png') !!}<span>Sandra smith<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar3.png') !!}<span>Amily Lee<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar4.png') !!}<span>Christopher Palmer<small>Hi! How're you?</small></span></a>
                <a href="javascript:void(0);" class="showRight2">{!! HTML::image('assets/images/avatar5.png') !!}<span>Nick Doe<small>Hi! How're you?</small></span></a>
            ...
            <div class="slimscroll chat">
                <div class="chat-item chat-item-left">
                    <div class="chat-image">
                        {!! HTML::image('assets/images/avatar2.png') !!}
        ...
        {!! HTML::script('assets/js/modern.js') !!}
